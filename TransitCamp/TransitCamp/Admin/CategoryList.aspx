<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="CategoryList.aspx.cs" Inherits="TransitCamp.Admin.CategoryList" %>
        ...
        <div class="row">
            <div class="table-container">
                ...
                <div class="table-wrp">
                    ...
                    <div class="w-25 float-left pt-4 pl-1"><a href="AddCategory"><b>Add</b></a></div>
