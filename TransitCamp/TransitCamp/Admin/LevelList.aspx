<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="LevelList.aspx.cs" Inherits="TransitCamp.Admin.LevelList" %>
    ...
    <div class="p-4">
        <div class="row">
            <div class="table-container">
                ...
                <div class="table-wrp">
                    <h3 class="mt-5">Level List</h3>

                    <div class="w-25 float-left pt-4 pl-1"><a href="AddLevel"><b>Add</b></a></div>
