<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ADOnHoldStatusList.aspx.cs" Inherits="TransitCamp.Admin.ADOnHoldStatusList" %>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        ...
                                        <span>
                                            <asp:Button ID="CancelButton" runat="server" CssClass="btn btn-primary grid-btn" CommandName="Cancel" OnClientClick="return confirm('Do you want to Cancle Reserve this entry?');" Text="Cancel" />
                                        </span>
                                    </ItemTemplate>
                                </asp:TemplateField>
