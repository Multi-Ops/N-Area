<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="UnitList.aspx.cs" Inherits="TransitCamp.Admin.UnitList" %>
    ...
    <div class="p-4">
        ...
        <div class="row">
            <div class="table-container">
                ...
                <div class="table-wrp">
                    <h3 class="mt-5">Unit List</h3>

                    <div class="w-25 float-left pt-4 pl-1"><a href="AddUnit"><b>Add</b></a></div>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Action" ItemStyle-Width="15%">
                                    <ItemTemplate>
                                        ...
                                        <span>
                                            <asp:Button ID="DeleteButton" runat="server" CssClass="btn btn-primary grid-btn btn-del" CommandName="Delete" OnClientClick="return confirm('Do you want to delete this entry?');" Text="Delete" />
                                        </span>
                                    </ItemTemplate>
                                </asp:TemplateField>
