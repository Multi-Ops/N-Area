...
{
    public partial class BrigadeList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Paging.TotalItems = divisionservices.TotalItemsBrig();
        ...
        private void Bind()
        {
            ...
            var data = divisionservices.PagingBrig(PageSize, _skip);
        ...
        protected void grdUser_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    Response.Redirect("Brigade?DivID=" + Convert.ToString(Id));
                }
                else if (e.CommandName == "Delete")
                {
                    divisionservices = new DivisionServices(new TCContext());
                    divisionservices.DeleteBrig(Id);
                    Bind();
                }
                else
                {
        ...
        protected void search()
        {
            ...
            var data = divisionservices.GetSearchResultBrig(SearchText);
            grdUser.DataSource = data;
            grdUser.DataBind();
        }
