<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AddLevel.aspx.cs" Inherits="TransitCamp.Admin.AddLevel" %>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="icon-arrange">
                                        <asp:TextBox runat="server" ID="txtLevel" CssClass="form-control border-none" placeholder="Level Name"></asp:TextBox>
                                    </span>
                                    <asp:RequiredFieldValidator ID="rqfName" ValidationGroup="requiredgroup" runat="server" Display="Dynamic" ErrorMessage="Required Field!"
                                        ControlToValidate="txtLevel" ForeColor="Red" CssClass="required-filed-validator"></asp:RequiredFieldValidator>
                                </div>
                            </div>
