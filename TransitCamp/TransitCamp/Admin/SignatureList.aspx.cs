...
{
    public partial class SignatureList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Paging.TotalItems = signatureServices.TotalItems();
            #endregion
            if (!IsPostBack)
            {
                Bind();
        ...
        private void Bind()
        {
            ...
            var data = signatureServices.Paging(PageSize, _skip);
        ...
        protected void grdUser_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    Response.Redirect("AddSignature?SignatureID=" + Convert.ToString(Id));
                }
                else if (e.CommandName == "Delete")
                {
                    signatureServices = new SignatureServices(new TCContext());
                    signatureServices.Delete(Id);
                    Bind();
                }
                else
                {
        ...
        protected void search()
        {
            ...
            var data = signatureServices.GetSearchResult(SearchText);
            grdUser.DataSource = data;
            grdUser.DataBind();
        }
