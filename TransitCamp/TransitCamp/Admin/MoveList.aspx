<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="MoveList.aspx.cs" Inherits="TransitCamp.Admin.MoveList" %>
    ...
    <div class="p-4">
        <div class="row">
            <div class="table-container">
                ...
                <div class="table-wrp">
                    <h3 class="mt-5">M,Move List</h3>

                    <div class="w-25 float-left pt-4 pl-1"><a href="AddMove"><b>Add</b></a></div>
