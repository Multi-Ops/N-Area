<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ADListPriorityWise.aspx.cs" Inherits="TransitCamp.Admin.ADListPriorityWise" %>
                        ...
                        <asp:GridView runat="server" CssClass="table table-striped table-grid-one" ID="grdUser" DataKeyNames="ID" AutoGenerateColumns="false" OnRowDeleting="grdUser_RowDeleting" OnRowCommand="grdUser_RowCommand">
                            <Columns>
                                ...
                                <%--                                <asp:TemplateField HeaderText="Ref Doc">
                                    <ItemTemplate>
                                        <asp:HyperLink NavigateUrl='<%#Eval("DocumentUrl") %>' runat="server" Text='<%# (Eval("DocumentUrl", "{0:dd/MM/yyyy}") == "0" ? "" : "Download")%>'></asp:HyperLink>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>
