...
{
    public partial class OnHoldingReport : System.Web.UI.Page
    {
        ...
        protected void Bind()
        {
            ...
            var data = aDServices.PagingOnHolding();
        ...
        protected void BindSearch(DateTime date)
        {
            #region declare
            int lve = 0;
            int td = 0;
            ...
            var data = aDServices.GetByDateForOnHoldingReport(Convert.ToDateTime(finalstring), Convert.ToInt32(ddlCities.SelectedValue));
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            if (hfFromDate.Value != "")
            {
                BindSearch(Convert.ToDateTime(hfFromDate.Value));
                DateTime date = Convert.ToDateTime(hfFromDate.Value);
