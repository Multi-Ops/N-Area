<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ReserveManifestReport.aspx.cs" Inherits="TransitCamp.Reports.ReserveManifestReport" %>
                ...
                <div class="table-wrp">
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            ...
                            <div class="align">
                                Reserve MANIFEST OF TRANSIENTS MOV BY CHARTER FROM
