...
{
    public partial class MedicalStatusReport : System.Web.UI.Page
    {
        ...
        protected void Bind(DateTime from, DateTime to, Int64 id, int cid, string type)
        {
            ...
            var data = aDServices.MedicalStatusWiseReport(from, to, id, cid);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (hfFromDate.Value == "" && hfToDate.Value == "" && ddlMedicalStatus.SelectedValue != "")
                    {
                    ...
                    else
                    {
                        ...
                        {
                            Bind(fromdate, todate, id, Convert.ToInt32(ddlCities.SelectedValue), ddlMedicalStatus.SelectedItem.Text);
        ...
        {
            Response.Redirect("MedicalStatusReportDateWise");
        }
    }
}