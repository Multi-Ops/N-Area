...
{
    public partial class DepartureCityWise : System.Web.UI.Page
    {
        ...
        protected void BindDropDown()
        {
            ...
            ddlDCity.DataSource = data;
            ddlDCity.DataValueField = "ID";
            ddlDCity.DataTextField = "CityName";
            ddlDCity.DataBind();
            ddlDCity.Items.Insert(0, new ListItem("All", "0"));
        }

        protected void Bind(DateTime from, DateTime to, Int64 id, string type)
        {
            #region declare
            int lve = 0;
            int td = 0;
            ...
            var det = cityServices.GetCityDetails();
            var data = aDServices.DepartureCityWiseReport(from, to, id);
                    ...
                    foreach (var res in det)
                    {
                        if (data != null)
                        {
                            foreach (var r in data)
                            {
                                ...
                                dr["CityName"] = res.CityName;
                                dt.Rows.Add(dr);
                            }
                        }

                        var finaldata = data.OrderBy(x => x.CityName).ToList();
            ...
            lblDcity.Text = ddlDCity.SelectedItem.ToString();
            grd.DataSource = dt;
            grd.DataBind();
        }
        ...
        protected void Bind(Int64 id)
        {
            ...
            var data = aDServices.DepartureCityWiseReportID(id, finaldate);
            if (data != null)
            {
                #region lve
                var lveOfficer = (from p in data
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (hfFromDate.Value == "" && hfToDate.Value == "" && ddlDCity.SelectedValue != "")
                    {
                        Int64 id = Convert.ToInt64(ddlDCity.SelectedValue);
                        Bind(id);
                    }
                    else
                    {
                        ...
                        {
                            Bind(fromdate, todate, id, ddlDCity.SelectedItem.Text);
                            lblCity.Text = ddlDCity.SelectedItem.Text;
                        }
                    }
                }
            }
        ...
        {
            Response.Redirect("DepartureCityWiseDateWise");
        }
    }
}