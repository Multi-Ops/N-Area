...
{
    public partial class ADReportMoveTypeDateWise : System.Web.UI.Page
    {
        ...
        protected void Bind(Int64 id)
        {
            ...
            var data = aDServices.MoveTypeWiseReportByID(id, finaldate);
            ...
            hfFromDate.Value = finaldate.ToString("dd-MM-yyyy");
        ...
        protected void Bind(Int64 id, DateTime date, int cid, string type)
        {
            ...
            var data = aDServices.MoveTypeWiseReportByID(id, finaldate, cid);
