<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="FormationWiseSummaryDateRange.aspx.cs" Inherits="TransitCamp.Reports.FormationWiseSummaryDateRange" %>
            ...
            <div class="table-container">
                <div class="table-wrp">
                    ...
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            <div class="align">
                                Formation Arrival Summary (<asp:Label runat="server" ID="lblCity"></asp:Label>)
                                <br />
                                From:
