...
{
    public partial class DivisonWiseReportDateWise : System.Web.UI.Page
    {
        ...
        protected void Bind(Int64 id)
        {
            ...
            var data = aDServices.DivisionWiseReportID(id, finaldate);
        ...
        protected void Bind(Int64 id, DateTime date, int cid, string type)
        {
            ...
            var data = aDServices.DivisionWiseReportID(id, finaldate, cid);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            {
                if (hfFromDate.Value == "" && ddlDiv.SelectedValue != "")
                {
                    Int64 id = Convert.ToInt64(ddlDiv.SelectedValue);
                    Bind(id);
                }
                else
                {
                    ...
                    Bind(id, fromdate, Convert.ToInt32(ddlCities.SelectedValue), ddlDiv.SelectedItem.Text);
        ...
        {
            Response.Redirect("DivisonWiseReportDateWise");
        }
    }
}