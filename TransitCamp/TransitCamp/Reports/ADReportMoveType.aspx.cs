...
{
    public partial class ADReportMoveType : System.Web.UI.Page
    {
        ...
        protected void Bind(DateTime from, DateTime to, Int64 id, int cid, string type)
        {
            ...
            var data = aDServices.MoveTypeWiseReport(from, to, id, cid);
        ...
        protected void txtToday_Click(object sender, EventArgs e)
        {
            Response.Redirect("ADReportMoveTypeDateWise");
        }
    }
}