...
{
    public partial class DepartureUnitWiseReport : System.Web.UI.Page
    {
        ...
        protected void Bind(DateTime from, DateTime to, Int64 id, int cid, string type)
        {
            ...
            var data = aDServices.DepartureUnitWiseReport(from, to, id, cid);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (hfFromDate.Value == "" && hfToDate.Value == "" && ddlUnit.SelectedValue != "")
                    {
                    ...
                    else
                    {
                        ...
                        {
                            Bind(fromdate, todate, id, Convert.ToInt32(ddlCities.SelectedValue), ddlUnit.SelectedItem.Text);
        ...
        {
            Response.Redirect("DepartureUnitWiseReportDateWise");
        }
    }
}