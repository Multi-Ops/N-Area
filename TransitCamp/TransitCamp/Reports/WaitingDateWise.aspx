<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="WaitingDateWise.aspx.cs" Inherits="TransitCamp.Reports.WaitingDateWise" %>
            ...
            <div class="table-container">
                <div class="table-wrp">
                    <div class="mt-2 w-75 float-right">
                        <asp:Button runat="server" CssClass="float-left form-control custom-position btn float-right btn-block btn-primary" ID="btnToday" Visible="false" Text="Date Wise" OnClick="btnToday_Click"></asp:Button>
                        ...
                        <%--<asp:DropDownList runat="server" CssClass="float-left form-control float-right custom-position" ID="ddlDiv"></asp:DropDownList>--%>
                    ...
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            <div class="align">
                                Waiting Report (<asp:Label runat="server" ID="lblDiv"></asp:Label>)
                                <br />
                                Date:
                        ...
                        <div class="table-responsive table-grid">
                            <asp:GridView runat="server" ShowFooter="true" CssClass="table table-striped table-grid-one grid" ID="grd" AutoGenerateColumns="false" OnRowCreated="grd_RowCreated" PageSize="35">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="Holding Status">
                                        <ItemTemplate>
                                            <%#Eval("OnHoldRemark") %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                        ...
                        <div runat="server" id="divTbl">
                            <table class="table tbtblnc">
                                ...
                                <tr class="total">
                                    <td>Officer</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblOfficer"></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr class="total">
                                    <td>Jcos</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblJCOs"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="total">
                                    <td>OR</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblOR"></asp:Label>
                                    </td>
                                </tr>
                                <tr class="total sum">
                                    <td>Number Of Transients</td>
                                    <td>
                                        <asp:Label runat="server" ID="lblNoOfTrans"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </div>
