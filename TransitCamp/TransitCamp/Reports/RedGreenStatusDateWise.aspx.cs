...
{
    public partial class RedGreenStatusDateWise : System.Web.UI.Page
    {
        ...
        //    var data = aDServices.StatusWiseReportID(id, finaldate, cid);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            {
                if (hfFromDate.Value == "" && ddlStatus.SelectedValue != "")
                {
                    Int64 id = Convert.ToInt64(ddlStatus.SelectedValue);
                    //Bind(id);
                }
                else
                {
                    ...
                    Bind(id, fromdate, Convert.ToInt32(ddlCities.SelectedValue), ddlStatus.SelectedItem.Text);
