...
{
    public partial class DepartureTransportWiseDateWise : System.Web.UI.Page
    {
        ...
        protected void Bind(Int64 id, DateTime date, int cID, string type)
        {
            ...
            if (type.ToLower().Trim() == "all")
            {
                if (tDetails != null)
                {
                    var data = manifestServices.DepartureTransportTypeReportID(id, finaldate, cID);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            {
                if (hfFromDate.Value == "" && ddlTransport.SelectedValue != "")
                {
                    Int64 id = Convert.ToInt64(ddlTransport.SelectedValue);
                    Bind(id);
                }
                else
                {
                    ...
                    Bind(id, fromdate, Convert.ToInt32(ddlCities.SelectedValue), ddlTransport.SelectedItem.Text);
