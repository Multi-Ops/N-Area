...
{
    public partial class DepartureMoveType : System.Web.UI.Page
    {
        ...
        protected void Bind(DateTime from, DateTime to, Int64 id, int cID, string type)
        {
            ...
            var data = aDServices.DepartureMoveTypeWiseReport(from, to, id, cID);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (hfFromDate.Value == "" && hfToDate.Value == "" && ddlMoveType.SelectedValue != "")
                    {
                    ...
                    else
                    {
                        ...
                        {
                            Bind(fromdate, todate, id, Convert.ToInt32(ddlCities.SelectedValue), ddlMoveType.SelectedItem.Text);
