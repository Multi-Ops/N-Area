...
{
    public partial class HoldStatusReportDateWise : System.Web.UI.Page
    {
        ...
        protected void BindSearch(DateTime fromdate, DateTime todate, int cid)
        {
            ...
            var data = aDServices.GetByDateForHoldingReportDateRange(fromdatefinal, todatefinal, cid);
            if (data != null)
            {
                #region lve
        ...
        private void AddTotalRow(string cat)
        {
            ...
            row.Cells.AddRange(new TableCell[13] { new TableCell { Text = cat, HorizontalAlign = HorizontalAlign.Left},
                                        new TableCell (),
                                        new TableCell (),
                                        new TableCell (),
                                        new TableCell (),
        ...
        {
            Response.Redirect("HoldingReport");
        }
    }
}