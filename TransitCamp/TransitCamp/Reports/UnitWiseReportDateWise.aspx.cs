...
{
    public partial class UnitWiseReportDateWise : System.Web.UI.Page
    {
        ...
        protected void Bind(Int64 id)
        {
            ...
            var data = aDServices.UnitWiseReportID(id, finaldate);
        ...
        protected void Bind(Int64 id, DateTime date, int cid, string type)
        {
            ...
            var data = aDServices.UnitWiseReportID(id, finaldate, cid);
