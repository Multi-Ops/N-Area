<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="DepartureUnitWiseSummary.aspx.cs" Inherits="TransitCamp.Reports.DepartureUnitWiseSummary" %>
    ...
    <div class="overflow-hidden">
        <div class="row">
            <div class="table-container">
                <div class="table-wrp">
                    <a class="float-left border-none" style="margin: 28px 0px 0px 10px; text-align: right; font-size: 15px; font-weight: bold; color: #262b40;" href="DepartureUnitWiseSummaryDateRange">Date Range Selection (From - TO)</a>
                    ...
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            <div class="align">
                                Unit Wise Departure Summary(<asp:Label runat="server" ID="lblCity"></asp:Label>)
                                <br />
                                Date:
