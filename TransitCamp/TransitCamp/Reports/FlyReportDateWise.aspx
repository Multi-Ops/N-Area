<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="FlyReportDateWise.aspx.cs" Inherits="TransitCamp.Reports.FlyReportDateWise" %>
                    ...
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            <div class="align">
                                ...
                                Manifest Summary (<asp:Label runat="server" ID="lblFrom"></asp:Label>
                                -
