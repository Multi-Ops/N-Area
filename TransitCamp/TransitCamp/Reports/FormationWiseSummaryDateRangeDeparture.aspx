<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="FormationWiseSummaryDateRangeDeparture.aspx.cs" Inherits="TransitCamp.Reports.FormationWiseSummaryDateRangeDeparture" %>
            ...
            <div class="table-container">
                <div class="table-wrp">
                    ...
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            <div class="align">
                                Formation Departure Summary (<asp:Label runat="server" ID="lblCity"></asp:Label>)
                                <br />
                                From:
