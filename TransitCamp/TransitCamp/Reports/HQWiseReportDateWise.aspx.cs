...
{
    public partial class HQWiseReportDateWise : System.Web.UI.Page
    {
        ...
        protected void Bind(Int64 id)
        {
            ...
            var data = aDServices.HQWiseReportID(id, finaldate);
        ...
        protected void Bind(Int64 id, DateTime date, int cid, string type)
        {
            ...
            var data = aDServices.HQWiseReportID(id, finaldate, cid);
