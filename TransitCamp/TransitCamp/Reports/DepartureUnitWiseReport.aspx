<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="DepartureUnitWiseReport.aspx.cs" Inherits="TransitCamp.Reports.DepartureUnitWiseReport" %>
            ...
            <div class="table-container">
                <div class="table-wrp">
                    <div class="mt-2 w-75 float-right">
                        ...
                        <asp:TextBox runat="server" CssClass="float-left form-control fromdate float-right custom-position" ID="txtFrom" placeholder="From" for="ContentPlaceHolder1_hfFromDate" ReadOnly="true" data-date-format="dd-mm-yyyy" data-link-field="ContentPlaceHolder1_hfFromDate"></asp:TextBox>
