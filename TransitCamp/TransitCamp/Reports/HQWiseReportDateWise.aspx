<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="HQWiseReportDateWise.aspx.cs" Inherits="TransitCamp.Reports.HQWiseReportDateWise" %>
    ...
    <div class="overflow-hidden">
        <div class="row">
            <div class="table-container">
                <a class="float-left border-none" style="margin: 28px 0px 0px 10px; text-align: right; font-size: 15px; font-weight: bold; color: #262b40;" href="HQWiseReport">Date Range Selection (From - TO)</a>
                <div class="table-wrp">
