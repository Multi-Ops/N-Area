...
{
    public partial class ArrivalCityDateWise : System.Web.UI.Page
    {
        ...
        protected void Bind(Int64 id, DateTime date, string type)
        {
            #region declare
            int lve = 0;
            int td = 0;
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Bind(id, fromdate, ddlCity.SelectedItem.Text);
