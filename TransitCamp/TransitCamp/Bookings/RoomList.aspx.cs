...
namespace TransitCamp.Bookings
{
    public partial class RoomList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Paging.TotalItems = bookingServices.TotalItemsRoom();
            #endregion
            if (!IsPostBack)
            {
                Bind();
        ...
        private void Bind()
        {
            ...
            var data = bookingServices.PagingRoom(PageSize, _skip);
        ...
        protected void grdUser_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    Response.Redirect("AddRoom?RoomID=" + Convert.ToString(Id));
                }
                else if (e.CommandName == "Delete")
                {
                    bookingServices = new BookingServices(new TCContext());
                    bookingServices.DeleteRoom(Id);
                    Bind();
                }
                else
                {
        ...
        protected void search()
        {
            ...
            var data = bookingServices.GetSearchResultRoom(SearchText);
            grdUser.DataSource = data;
            grdUser.DataBind();
        }
