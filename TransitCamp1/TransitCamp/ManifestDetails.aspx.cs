...
{
    public partial class ManifestDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (ManifestNo != null)
                Paging.TotalItems = manifestServices.TotalItemsManifestDetails(ManifestNo);
            else
                Paging.TotalItems = manifestServices.TotalItemsManifestDetails();
