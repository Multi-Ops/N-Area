<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AllManifests.aspx.cs" Inherits="TransitCamp.Admin.AllManifests" %>
            ...
            <ContentTemplate>
                <div class="row">
                    <div class="table-container">
                        ...
                        <div class="table-wrp">
                            <h3 class="mt-5">Manifest List</h3>

                            <div class="float-left pt-4 pl-1 pr-4"><a href="Manifest"><b>Add</b></a></div>
                            <div class="float-left pt-4 pl-1"><a href="AllReserveManifests"><b>Reserve Manifests</b></a></div>
