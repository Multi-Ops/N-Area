<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AddCamp.aspx.cs" Inherits="TransitCamp.Admin.AddCampList" %>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="icon-arrange">
                                        <asp:TextBox runat="server" ID="txtCamp" CssClass="form-control border-none" placeholder="Camp Name"></asp:TextBox>
                                    </span>
                                    <asp:RequiredFieldValidator ID="rqfCamp" ValidationGroup="requiredgroup" runat="server" Display="Dynamic" ErrorMessage="Required Field!"
                                        ControlToValidate="txtCamp" ForeColor="Red" CssClass="required-filed-validator"></asp:RequiredFieldValidator>
                                </div>
                            </div>
