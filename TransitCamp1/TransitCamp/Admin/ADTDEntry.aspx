<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ADTDEntry.aspx.cs" Inherits="TransitCamp.Admin.ADTDEntry" %>
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="mb-4 mb-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-800">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-0 h3">AD TD Entry</h1>
                        </div>
                        <form action="#">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="icon-arrange">
                                        <asp:DropDownList runat="server" ID="ddlLevel" CssClass="form-control border-none"></asp:DropDownList>
                                    </span>
                                </div>
                                <div class="col">
                            ...
                            <div class="row mt-4 mb-3">
                                ...
                                <div class="col">
                                    <label for="email">Out Date</label>
                                    <span class="icon-arrange">
                            ...
                            <div class="row mt-4">
                                <div class="col">
                                    ...
                                    <span class="icon-arrange">
                                        <asp:TextBox runat="server" ID="txtRemark" TextMode="MultiLine" CssClass="form-control border-none"></asp:TextBox>
                                    </span>
                                </div>
                            </div>
