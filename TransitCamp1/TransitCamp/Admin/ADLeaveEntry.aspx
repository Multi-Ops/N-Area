<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ADLeaveEntry.aspx.cs" Inherits="TransitCamp.Admin.ADLeaveEntry" %>
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="mb-4 mb-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-800">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-0 h3">AD Leave Entry</h1>
                        </div>
                        <form action="#">
                            <div class="row">
                                <div class="col">
