...
{
    public partial class ADOnHoldStatusList : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Paging.TotalItems = aDServices.TotalItemsOnHoldStatus();
            #endregion
            if (!IsPostBack)
            {
                Bind();
        ...
        private void Bind()
        {
            ...
            var data = aDServices.PagingOnHoldFinal(PageSize, _skip);
            ...
            try
            {
                ...
                else if (e.CommandName == "Cancel")
                {
                    ...
                    if (getdata != null)
                    {
                        ...
                        aDServices.Save();
                        Response.Redirect("ADOnHoldStatusList");
                    }
                }
            }
            catch (Exception)
        ...
        protected void search()
        {
            ...
            var data = aDServices.GetSearchResultOnHoldStatus(SearchText);
            grdUser.DataSource = data;
            grdUser.DataBind();
        }
