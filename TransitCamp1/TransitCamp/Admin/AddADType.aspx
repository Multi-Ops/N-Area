<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="AddADType.aspx.cs" Inherits="TransitCamp.Admin.AddADType" %>
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="mb-4 mb-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        <div class="text-center text-md-center mb-4 mt-md-0">
                            <h1 class="mb-0 h3">Add AD Type</h1>
                        </div>
                        <form action="#">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="icon-arrange">
                                        <asp:TextBox runat="server" ID="txtADT" CssClass="form-control border-none" placeholder="AD Type Name"></asp:TextBox>
                                    </span>
                                    <asp:RequiredFieldValidator ID="rqfName" ValidationGroup="requiredgroup" runat="server" Display="Dynamic" ErrorMessage="Required Field!"
                                        ControlToValidate="txtADT" ForeColor="Red" CssClass="required-filed-validator"></asp:RequiredFieldValidator>
                                </div>
                            </div>
