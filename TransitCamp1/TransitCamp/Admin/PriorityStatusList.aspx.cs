...
{
    public partial class PriorityStatusList : System.Web.UI.Page
    {
        IPriorityStatusServices priorityStatusServices;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Paging.TotalItems = priorityStatusServices.TotalItems();
            #endregion
            if (!IsPostBack)
            {
                Bind();
        ...
        private void Bind()
        {
            ...
            var data = priorityStatusServices.Paging(PageSize, _skip);
        ...
        protected void grdUser_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                {
                    Response.Redirect("AddPriorityStatus?PriorityStatusID=" + Convert.ToString(Id));
                }
                else if (e.CommandName == "Delete")
                {
                    priorityStatusServices = new PriorityStatusServices(new TCContext());
                    priorityStatusServices.Delete(Id);
                    Bind();
                }
                else
                {
        ...
        protected void search()
        {
            ...
            var data = priorityStatusServices.GetSearchResult(SearchText);
            grdUser.DataSource = data;
            grdUser.DataBind();
        }
