...
{
    public partial class ADListOnTempHold : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Paging.TotalItems = aDServices.TotalItemsOnTemHold();
            #endregion
            if (!IsPostBack)
            {
                Bind();
        ...
        private void Bind()
        {
            ...
            var data = aDServices.PagingOnHold(PageSize, _skip);
            ...
            try
            {
                ...
                else if (e.CommandName == "Cancel")
                {
                    ...
                    if (getdata != null)
                    {
                        ...
                        aDServices.Save();
                        Response.Redirect("ADListOnTempHold");
                    }
                }
            }
            catch (Exception)
        ...
        protected void search()
        {
            ...
            var data = aDServices.GetSearchResultTempHold(SearchText);
            grdUser.DataSource = data;
            grdUser.DataBind();
        }
