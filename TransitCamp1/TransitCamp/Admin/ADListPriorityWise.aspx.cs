...
{
    public partial class ADListPriorityWise : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Paging.TotalItems = aDServices.TotalItemsPriority();
            #endregion
            if (!IsPostBack)
            {
                Bind();
        ...
        private void Bind()
        {
            ...
            var data = aDServices.PagingPriority(PageSize, _skip);
            ...
            try
            {
                ...
                else if (e.CommandName == "Cancel")
                {
                    ...
                    if (getdata != null)
                    {
                        ...
                        aDServices.Save();
                        Response.Redirect("ADListPriorityWise");
                    }
                }
            }
            catch (Exception)
        ...
        protected void search()
        {
            ...
            var data = aDServices.GetSearchResultPriority(SearchText);
            grdUser.DataSource = data;
            grdUser.DataBind();
        }
