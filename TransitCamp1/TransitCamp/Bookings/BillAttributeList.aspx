<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="BillAttributeList.aspx.cs" Inherits="TransitCamp.Bookings.BillAttributeList" %>
    ...
    <div class="p-4">
        <div class="row">
            <div class="table-container">
                ...
                <div class="table-wrp">
                    <h3 class="mt-5">Bill Attribute List</h3>

                    <div class="w-25 float-left pt-4 pl-1"><a href="AddBillAttribute"><b>Add</b></a></div>
                    ...
                    <div class="table-responsive table-grid float-left w-100">
                        ...
                        <asp:GridView runat="server" CssClass="table table-striped table-grid-one" ID="grdUser" DataKeyNames="ID" AutoGenerateColumns="false" OnRowDeleting="grdUser_RowDeleting" OnRowCommand="grdUser_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="LRC Price">
                                    <ItemTemplate>
                                        <%#Eval("LRCPrice") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Non LRC Price">
                                    <ItemTemplate>
                                        <%#Eval("NonLRCPrice") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
