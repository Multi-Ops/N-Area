<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="RoomList.aspx.cs" Inherits="TransitCamp.Bookings.RoomList" %>
        ...
        <div class="row">
            <div class="table-container">
                ...
                <div class="table-wrp">
                    ...
                    <div class="w-25 float-left pt-4 pl-1"><a href="AddRoom"><b>Add</b></a></div>
                    ...
                    <div class="table-responsive table-grid float-left w-100">
                        ...
                        <asp:GridView runat="server" CssClass="table table-striped table-grid-one" ID="grdUser" DataKeyNames="ID" AutoGenerateColumns="false" OnRowDeleting="grdUser_RowDeleting" OnRowCommand="grdUser_RowCommand">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Room Cap">
                                    <ItemTemplate>
                                        <%#Eval("MaxRoomCap") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="IsShareable">
                                    <ItemTemplate>
                                        <%#Eval("IsShare") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
