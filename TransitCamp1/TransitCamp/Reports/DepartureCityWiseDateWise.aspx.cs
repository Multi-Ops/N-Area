...
{
    public partial class DepartureCityWiseDateWise : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Bind(id, ddlDCity.SelectedItem.Text);
            }
        }
        ...
        protected void Bind(DateTime date, Int64 id, string type)
        {
            #region declare
            int lve = 0;
            int td = 0;
        ...
        protected void Bind(Int64 id, string type)
        {
            #region declare
            int lve = 0;
            int td = 0;
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            {
                if (hfFromDate.Value == "" && ddlDCity.SelectedValue != "")
                {
                    Int64 id = Convert.ToInt64(ddlDCity.SelectedValue);
                    Bind(id, ddlDCity.SelectedItem.Text);
                }
                else
                {
                    ...
                    Bind(fromdate, id, ddlDCity.SelectedItem.Text);
