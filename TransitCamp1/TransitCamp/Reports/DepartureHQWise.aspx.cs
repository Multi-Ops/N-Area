...
{
    public partial class DepartureHQWise : System.Web.UI.Page
    {
        ...
        protected void Bind(DateTime from, DateTime to, Int64 id, int cid, string type)
        {
            ...
            var data = aDServices.DepartureWiseReport(from, to, id, cid);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    if (hfFromDate.Value == "" && hfToDate.Value == "" && ddlHQ.SelectedValue != "")
                    {
                    ...
                    else
                    {
                        ...
                        {
                            Bind(fromdate, todate, id, Convert.ToInt32(ddlCities.SelectedValue), ddlHQ.SelectedItem.Text);
        ...
        {
            Response.Redirect("DepartureHQWiseDateWise");
        }
    }
}