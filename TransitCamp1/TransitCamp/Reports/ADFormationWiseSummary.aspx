<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ADFormationWiseSummary.aspx.cs" Inherits="TransitCamp.ADFormationWiseSummary" %>
            ...
            <div class="table-container">
                <div class="table-wrp">
                    ...
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            <div class="align">
                                Formation Wise AD Summary(<asp:Label runat="server" ID="lblCity"></asp:Label>)
                                <br />
                                Date:
