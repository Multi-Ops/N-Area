...
{
    public partial class MedicalStatusReportDateWise : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                BindDropDown();
                //Int64 id = Convert.ToInt64(ddlMedicalStatus.SelectedValue);
                //Bind(id);
                BindCities();
        ...
        protected void BindDropDown()
        {
            ...
            var data = medicalStatusServices.getmeddetails();
            ddlMedicalStatus.DataSource = data;
            ddlMedicalStatus.DataValueField = "ID";
            ddlMedicalStatus.DataTextField = "MedicalStatusName";
            ddlMedicalStatus.DataBind();
            ddlMedicalStatus.Items.Insert(0, new ListItem("All", "0"));
        }
        ...
        //    var data = aDServices.MedicalStatusWiseReportID(id, finaldate);
        ...
        //    lblHQ.Text = ddlMedicalStatus.SelectedItem.ToString();
        //    grd.DataSource = dt;
        //    grd.DataBind();
        //}
        ...
        protected void Bind(Int64 id, DateTime date, int cid, string type)
        {
            ...
            var det = medicalStatusServices.getmeddetails();
            var data = aDServices.MedicalStatusWiseReportID(id, finaldate, cid);
            if (type.ToLower().Trim() == "all")
            {
                if (det != null)
                {
                    foreach (var res in det)
                    {
                        ...
                        var finaldata = data.OrderBy(x => x.MedicalStatusName).ToList();
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    if (e.Row.DataItem as DataRowView != null)
                    {
                        ...
                        String Id = Convert.ToString(dt.Rows[e.Row.RowIndex]["MedicalStatusName"]);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            if (ddlMedicalStatus.SelectedValue == "")
            {
            ...
            {
                if (hfFromDate.Value == "" && ddlMedicalStatus.SelectedValue != "")
                {
                    Int64 id = Convert.ToInt64(ddlMedicalStatus.SelectedValue);
                    //Bind(id);
                }
                else
                {
                    ...
                    Bind(id, fromdate, Convert.ToInt32(ddlCities.SelectedValue), ddlMedicalStatus.SelectedItem.Text);
