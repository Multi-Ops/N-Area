...
{
    public partial class DepartureHQWiseDateWise : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                BindCity();
                Int64 id = Convert.ToInt64(ddlHQ.SelectedValue);
                //Bind(id);
                BindCities();
            }
        }
        ...
        protected void BindCity()
        {
            ...
            var data = headquarterServices.GetHQDetails();
            ddlHQ.DataSource = data;
        ...
        protected void Bind(Int64 id)
        {
            ...
            var data = aDServices.DepartureWiseReportID(id, finaldate);
            ...
            lblHQ.Text = ddlHQ.SelectedItem.ToString();
            grd.DataSource = dt;
            grd.DataBind();
        ...
        protected void Bind(Int64 id, DateTime date, int cid, string type)
        {
            ...
            var det = headquarterServices.GetHQDetails();
            var data = aDServices.DepartureWiseReportID(id, finaldate, cid);
            ...
            if (type.ToLower().Trim() == "all")
            {
                if (det != null)
                {
                    foreach (var res in det)
                    {
                        ...
                        var finaldata = data.OrderBy(x => x.HQName).ToList();
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    if (e.Row.DataItem as DataRowView != null)
                    {
                        ...
                        String Id = Convert.ToString(dt.Rows[e.Row.RowIndex]["HQName"]);
        ...
        protected void btnSearchAD_Click(object sender, EventArgs e)
        {
            ...
            {
                if (hfFromDate.Value == "" && ddlHQ.SelectedValue != "")
                {
                    Int64 id = Convert.ToInt64(ddlHQ.SelectedValue);
                    Bind(id);
                }
                else
                {
                    ...
                    Bind(id, fromdate, Convert.ToInt32(ddlCities.SelectedValue), ddlHQ.SelectedItem.Text);
