<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HoldingReport.aspx.cs" Inherits="TransitCamp.Reports.HoldingReport" MasterPageFile="~/SiteMaster.Master" %>
    ...
    <div class="overflow-hidden">
        <div class="row">
            <div class="table-container">
                <div class="table-wrp">
                    <a class="float-left border-none" style="margin: 28px 0px 0px 10px; text-align: right; font-size: 15px; font-weight: bold; color: #262b40;" href="HoldStatusReportDateWise">Date Range Selection (From - TO)</a>
                        ...
                        <div class="table-responsive table-grid">
                            <asp:GridView runat="server" ShowFooter="true" CssClass="table table-striped table-grid-one grid" ID="grd" AutoGenerateColumns="false" OnRowCreated="grd_RowCreated">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" HeaderText="Can Date">
                                        <ItemTemplate>
