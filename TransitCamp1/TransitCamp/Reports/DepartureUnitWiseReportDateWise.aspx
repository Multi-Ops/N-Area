<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="DepartureUnitWiseReportDateWise.aspx.cs" Inherits="TransitCamp.Reports.DepartureUnitWiseReportDateWise" %>
    ...
    <div class="overflow-hidden">
        <div class="row">
            <div class="table-container">
                <div class="table-wrp">
                    <a class="float-left border-none" style="margin: 28px 0px 0px 10px; text-align: right; font-size: 15px; font-weight: bold; color: #262b40;" href="DepartureUnitWiseReport">Date Range Selection (From - TO)</a>
                    ...
                    <div class="mt-2 w-75 float-right">
                        ...
                        <asp:DropDownList runat="server" CssClass="float-left form-control float-right custom-position" ID="ddlUnit"></asp:DropDownList>
                    ...
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            <div class="align">
                                ...
                                Departure Unit Wise Report (<asp:Label runat="server" ID="lblUnit"></asp:Label>)
                                <br />
                                Date:
