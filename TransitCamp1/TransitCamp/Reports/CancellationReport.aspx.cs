...
namespace TransitCamp.Reports
{
    public partial class CancellationReport : System.Web.UI.Page
    {
        ...
        protected void Bind()
        {
            ...
            var data = cancelServices.GetManifestByDate(finaldate, Convert.ToInt32(ddlCities.SelectedValue));
            ...
            if (data != null)
            {
                foreach (var res in data)
                {
                    ...
                    var getdatadetails = cancelServices.GetManifestForReportByDate(res.MenifestNo, finaldate, Convert.ToInt32(ddlCities.SelectedValue));
        ...
        protected void BindSelected(DateTime date)
        {
            transportDetailServices = new TransportDetailsServices(new TCContext());
            categoryServices = new CategoryServices(new TCContext());
            cancelServices = new CancelServices(new TCContext());
