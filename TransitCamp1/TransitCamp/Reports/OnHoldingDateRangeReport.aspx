<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="OnHoldingDateRangeReport.aspx.cs" Inherits="TransitCamp.Reports.OnHoldingDateRangeReport" %>
            ...
            <div class="table-container">
                <div class="table-wrp">
                    <div class="mt-2 w-75 float-right">
                        ...
                        <asp:Button runat="server" CssClass="float-left form-control custom-position float-right btn btn-block btn-primary" ID="btnSearchAD" Text="Search" OnClick="btnSearchAD_Click1"></asp:Button>
