<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ADReportMoveTypeDateWise.aspx.cs" Inherits="TransitCamp.Reports.ADReportMoveTypeDateWise" %>
    ...
    <div class="overflow-hidden">
        <div class="row">
            <div class="table-container">
                <div class="table-wrp">
                    <a class="float-left border-none" style="margin: 28px 0px 0px 10px; text-align: right; font-size: 15px; font-weight: bold; color: #262b40;" href="ADReportMoveType">Date Range Selection (From - TO)</a>
                    ...
                    <div id="PrintDiv" runat="server">
                        <div class="head-text">
                            <div class="align">
                                ...
                                Arrival Move Type Report (<asp:Label runat="server" ID="lblMoveType"></asp:Label>)
                                <br />
                                Date:
