...
{
    public partial class FormationWiseSummaryDateRangeDeparture : System.Web.UI.Page
    {
        ...
        protected void Bind(DateTime from, DateTime to, Int64 id)
        {
            ...
            if (formation.Count > 0)
            {
                foreach (var f in formation)
                {
                    ...
                    dr["FMN"] = f.DivName;
                    var data = aDServices.CityWiseReportdeparture(from, to, id);
        ...
        {
            Response.Redirect("FormationWiseSummaryDeparture");
        }
    }
}