<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="ADReportMoveType.aspx.cs" Inherits="TransitCamp.Reports.ADReportMoveType" %>
            ...
            <div class="table-container">
                <div class="table-wrp">
                    <div class="mt-2 w-75 float-right">
                        <asp:Button runat="server" CssClass="float-left form-control float-right custom-position btn btn-block btn-primary" ID="txtToday" Text="Date Wise" OnClick="txtToday_Click"></asp:Button>
